...
public class FinalHttp {
    ...
    private static final String HEADER_CONTENT_TYPE_MULTIPART = "multipart/form-data";
...
//            contentType = HEADER_CONTENT_TYPE_MULTIPART;
...
//        if (contentType == null)
//            contentType = HEADER_CONTENT_TYPE_VALUE;
        sendRequest(httpClient, httpContext, addEntityToRequestBase(post, entity), contentType, callBack);
    }
    ...
    protected <T> void sendRequest(
            DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, AjaxCallBack<T> ajaxCallBack) {
        if (contentType != null) {
